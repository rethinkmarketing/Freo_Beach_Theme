                                    ...
                                    if (styles[i] !== null) {
                                        ...
                                        if (type === 'expand' || type === 'multi' || type === 'group') {
                                            ...
                                            if (styleData.prop !== und) {
                                                Rules[module][id] = self.getStyleData(styleData, parent);
                                                ...
                                                if (type === 'box_shadow' || type === 'text_shadow') {
                                                    ...
                                                    for (let j = vals.length - 1; j > -1; --j) {
                                                        let k = id + '_' + vals[j];
                                                        Rules[module][k] = self.getStyleData(styleData, parent);
                                                        if (vals[j] !== 'color') {
                                                    ...
                                                    Rules[module][id+'_regular']=self.getStyleData(styleData, parent);
                                                    ...
                                                    for (let j = vals.length-1; j > -1; --j) {
                                                        let k = id + '_' + vals[j];
                                                        if (is_border === true) {
                                                            Rules[module][k + '_style'] = self.getStyleData(styleData, parent);
                                                            Rules[module][k + '_color'] = self.getStyleData(styleData, parent);
                                                    ...
                                                    Rules[module][id + '-gradient'] = self.getStyleData(styleData, parent);
                                                    ...
                                                    if (type === 'imageGradient') {
                                                        Rules[module][id + '-type'] = {type: 'radio', p: parent};
                                                        //bg
                                                        Rules[module][styleData.colorId] = self.getStyleData(styleData, parent);
                                                    ...
                                                    for (let j = vals.length - 1; j > -1; --j) {
                                                        Rules[module][id + '_' + vals[j]] = self.getStyleData(styleData, parent);
                                                    }
                                                    ...
                                                    let t_data = self.getStyleData(styleData, parent);
