...
?>
<!-- module social share -->
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args));?> data-title="<?php true === $loop?the_title():wp_title(); ?>" data-url="<?php true===$loop?the_permalink():''; ?>">
