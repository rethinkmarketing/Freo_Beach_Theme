...
class Themify_Builder_Component_Base {
    ...
    public function get_styling() {
        ...
        $options[] = self::get_expand('zi',array(
                self::get_zindex()
            )
        );
    ...
    protected static function get_aspect_ratio($selector = '', $id = 'asp', $state = '') {
    ...
    protected static function get_height($selector = '', $id = 'ht', $state = '',$minH='',$maxH='') {
